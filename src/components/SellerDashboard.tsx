...
import { Seller, PartListing } from "../types";
import { Plus, Sparkles, Star, CheckCircle, CreditCard, LogIn, LogOut, Package, User, PlusCircle, Trash2, ArrowLeft, Loader2, Building, Phone } from "lucide-react";
      ...
      {showCheckout && (
        <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 bg-slate-50 rounded-xl p-5 border border-slate-100">
              <span className="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-4">
                2. Card Billing Details
              </span>
